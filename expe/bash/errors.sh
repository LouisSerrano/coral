...
sub_tr=0.05
sub_te=0.05
python3 expe/errors/errors_inr.py "optim.batch_size=$batch_size" "data.sub_from=$sub_from" "data.sub_tr=$sub_tr" "data.sub_te=$sub_te"
sub_from=4
sub_tr=0.2
sub_te=0.2
python3 expe/errors/errors_inr.py "optim.batch_size=$batch_size" "data.sub_from=$sub_from" "data.sub_tr=$sub_tr" "data.sub_te=$sub_te"
...
sub_tr=0.05
sub_te=0.05
python3 expe/errors/errors_operator.py "optim.batch_size=$batch_size" "data.setting=$setting" "data.sequence_length_in=$sequence_length_in" "data.sequence_length_out=$sequence_length_out" "data.sub_from=$sub_from" "data.sub_tr=$sub_tr" "data.sub_te=$sub_te"
sub_tr=0.2
sub_te=0.2
python3 expe/errors/errors_operator.py "optim.batch_size=$batch_size" "data.setting=$setting" "data.sequence_length_in=$sequence_length_in" "data.sequence_length_out=$sequence_length_out" "data.sub_from=$sub_from" "data.sub_tr=$sub_tr" "data.sub_te=$sub_te"
sub_tr=1
