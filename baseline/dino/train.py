...
from deepdish import config
from ode_model import Decoder, Derivative
from omegaconf import DictConfig, OmegaConf
from torch import nn
from torchdiffeq import odeint
from eval_dino import eval_dino, DetailedMSE
...
def main(cfg: DictConfig) -> None:
    ...
    for epoch in range(epochs):
        ...
        pred_train_mse, pred_train_inter_mse, pred_train_extra_mse, detailed_train_eval_mse = eval_dino(
            train_extra_loader, net_dyn, net_dec, device, method, criterion, state_dim, code_dim, coord_dim, 
        ...
        if step_show:
            ...
            pred_test_mse, pred_test_inter_mse, pred_test_extra_mse, detailed_test_mse = eval_dino(
                test_loader, net_dyn, net_dec, device, method, criterion, state_dim, code_dim, coord_dim, 
