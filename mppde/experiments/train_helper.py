...
def training_loop(model: torch.nn.Module,
    ...
    for (u_base, u_super, x, variables) in loader:
        ...
        # variables = {'alpha':0, 'beta':0, 'gamma':0} # TODO: ici on écrit en dur variables=empty car on en a pas + on n'a pas de u_base/u_super
        ...
        # print("steps : ", range(graph_creator.tw,
        #                           graph_creator.t_res - graph_creator.tw - (graph_creator.tw * unrolled_graphs)))
        # print("graph_creator.tw : ", graph_creator.tw)
        # print("graph_creator.t_res : ", graph_creator.t_res)
        ...
        # TODO: ici squeeze le C MAIS A ENLEVER PEUT ETRE POUR SW
        # data = data.squeeze()
...
def test_timestep_losses(model: torch.nn.Module,
    ...
    for step in steps:
        ...
        if (step != graph_creator.tw and step % graph_creator.tw != 0):
            ...
            print("step != graph_creator.tw : ", step != graph_creator.tw)
            print("step module graph_creator.tw : ", step % graph_creator.tw)
            print("hello world : \n\n")
            continue
